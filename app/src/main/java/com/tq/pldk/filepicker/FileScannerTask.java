...
import static com.tq.pldk.filepicker.util.FileUtils.getFileType;
...
import com.tq.pldk.filepicker.model.FileType;
...
//        }
    ...
    private List<FileEntity> getFiles(Cursor cursor) {
        ...
        while (cursor.moveToNext()) {
            ...
            if (path != null) {
                ArrayList<FileType> tqList = PickerManager.getInstance().getFileTypes();
                FileType fileType = getFileType(tqList, path);
